...
export const questions: Question[] = [
  createQuestion({
    id: 'r6a-06', questionNumber: 6, field: '基礎理論', subField: 'アルゴリズム', quoted: true,
  ...
  createQuestion({
    id: 'r6a-07', questionNumber: 7, field: 'システム開発', subField: 'プログラム言語', quoted: true,
  ...
  createQuestion({
    id: 'r6a-20', questionNumber: 20, field: 'コンピュータシステム', subField: 'システム構成', quoted: true,
  ...
  createQuestion({
    id: 'r6a-29', questionNumber: 29, field: 'データベース', subField: 'トランザクション', quoted: true,
  ...
  createQuestion({
    id: 'r6a-35', questionNumber: 35, field: 'ネットワーク', subField: 'TCP/IP', quoted: true,
  ...
  createQuestion({
    id: 'r6a-42', questionNumber: 42, field: '情報セキュリティ', subField: '暗号・認証', quoted: true,
  ...
  createQuestion({
    id: 'r6a-53', questionNumber: 53, field: 'プロジェクトマネジメント', subField: '進捗管理', quoted: true,
  ...
  createQuestion({
    id: 'r6a-65', questionNumber: 65, field: 'ストラテジ', subField: '経営分析', quoted: true,
  ...
  createQuestion({
    id: 'v110-sec-01', questionNumber: 101, field: '情報セキュリティ', subField: 'アクセス制御',
  ...
  createQuestion({
    id: 'v110-sec-02', questionNumber: 102, field: '情報セキュリティ', subField: '攻撃手法',
  ...
  createQuestion({
    id: 'v110-sec-03', questionNumber: 103, field: '情報セキュリティ', subField: '認証',
  ...
  createQuestion({
    id: 'v110-net-01', questionNumber: 104, field: 'ネットワーク', subField: 'IPアドレス',
  ...
  createQuestion({
    id: 'v110-net-02', questionNumber: 105, field: 'ネットワーク', subField: 'プロトコル',
  ...
  createQuestion({
    id: 'v110-db-01', questionNumber: 106, field: 'データベース', subField: '正規化',
  ...
  createQuestion({
    id: 'v110-db-02', questionNumber: 107, field: 'データベース', subField: 'SQL',
  ...
  createQuestion({
    id: 'v110-dev-01', questionNumber: 108, field: 'システム開発', subField: 'テスト',
  ...
  createQuestion({
    id: 'v110-dev-02', questionNumber: 109, field: 'システム開発', subField: '開発手法',
  ...
  createQuestion({
    id: 'v110-pm-01', questionNumber: 110, field: 'プロジェクトマネジメント', subField: 'スケジュール',
  ...
  createQuestion({
    id: 'v110-pm-02', questionNumber: 111, field: 'プロジェクトマネジメント', subField: 'リスク',
  ...
  createQuestion({
    id: 'v110-sm-01', questionNumber: 112, field: 'サービスマネジメント', subField: 'インシデント管理',
  ...
  createQuestion({
    id: 'v110-sm-02', questionNumber: 113, field: 'サービスマネジメント', subField: 'SLA',
  ...
  createQuestion({
    id: 'v110-audit-01', questionNumber: 114, field: 'システム監査', subField: '監査証拠',
  ...
  createQuestion({
    id: 'v110-audit-02', questionNumber: 115, field: 'システム監査', subField: '独立性',
  ...
  createQuestion({
    id: 'v110-st-01', questionNumber: 116, field: 'ストラテジ', subField: 'マーケティング',
  ...
  createQuestion({
    id: 'v110-st-02', questionNumber: 117, field: 'ストラテジ', subField: '法務',
